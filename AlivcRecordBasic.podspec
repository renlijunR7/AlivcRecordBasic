...
Pod::Spec.new do |s|
  s.name             = 'AlivcRecordBasic'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AlivcRecordBasic.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/孙震/AlivcRecordBasic'
  ...
  s.source_files = 'AlivcRecordBasic/Classes/**/*.{h,m,mm}'
  s.prefix_header_contents = '#import "AlivcMacro.h"','#import "AlivcImage.h"'
  s.static_framework = true
   s.resource_bundles = {
     'AlivcRecordBasic' => ['AlivcRecordBasic/Classes/**/*.xib']
   }
