...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message sureBtn:(NSString *)sureTitle cancleBtn:(NSString *)cancleTitle
{
    if (self == [super init]) {
        ...
        self.alertView.frame = CGRectMake(0, 0, AlertW, 120);
        ...
        self.lineView.frame = self.msgLbl?CGRectMake(0, CGRectGetMaxY(self.msgLbl.frame)+2*XLSpace, AlertW, 0):CGRectMake(0, CGRectGetMaxY(self.titleLbl.frame)+2*XLSpace, AlertW, 0);
        ...
        if(sureTitle){
            ...
            self.sureBtn = [UIButton buttonWithType:UIButtonTypeSystem];
            self.sureBtn.frame = CGRectMake(10, CGRectGetMaxY(self.lineView.frame), AlertW-20, 40);
            ...
            self.sureBtn.backgroundColor = [UIColor gradientColorWithSize:self.sureBtn.frame.size
        ...
        self.alertView.frame = CGRectMake(0, 0, AlertW, alertHeight+ 10);
        self.alertView.layer.position = self.center;
